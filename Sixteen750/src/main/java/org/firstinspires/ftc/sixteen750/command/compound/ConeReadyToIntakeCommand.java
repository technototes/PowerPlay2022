...
import org.firstinspires.ftc.sixteen750.command.lift.LiftFloorIntakeCommand;
...
public class ConeReadyToIntakeCommand extends SequentialCommandGroup {
    public ConeReadyToIntakeCommand(LiftSubsystem lift, ClawSubsystem claw) {
        super(new ClawOpenCommand(claw), new ClawCarryCommand(claw), new LiftFloorIntakeCommand(lift));
    }
}
