...
public class DriveCommand implements Command, Loggable {
    ...
    private void autoAlign45() {
        ...
        if (Math.abs(rotPower) > .000001) {
            ...
            if (jx > VisionPipeline.VisionConstants.JunctionDetection.OnlyXRight.RIGHT_CENTER) {
                subsystem.setWeightedDrivePower(
                    new Pose2d(
                        // moving only x, to the right
                        Range.clip(
                            (jx - VisionPipeline.VisionConstants.JunctionDetection.OnlyXRight.RIGHT_CENTER) /
                            VisionPipeline.VisionConstants.JunctionDetection.OnlyXRight.RIGHT_RANGE,
                            0,
                            0.3
                        ),
                        0,
            ...
            } else if (jx < VisionPipeline.VisionConstants.JunctionDetection.OnlyXLeft.LEFT_CENTER) {
                subsystem.setWeightedDrivePower(
                    new Pose2d(
                        // moving only x, to the left
                        Range.clip(
                            (jx - VisionPipeline.VisionConstants.JunctionDetection.OnlyXLeft.LEFT_CENTER) /
                            VisionPipeline.VisionConstants.JunctionDetection.OnlyXLeft.LEFT_RANGE,
                            -0.3,
                            0
                        ),
                        0,
            ...
            } else if (jy < VisionPipeline.VisionConstants.JunctionDetection.OnlyYForward.FORWARD_CENTER && jy > 10) {
                subsystem.setWeightedDrivePower(
                    new Pose2d(
                        0,
                        // Moving y forward
                        Range.clip(
                            (jy - VisionPipeline.VisionConstants.JunctionDetection.OnlyYForward.FORWARD_CENTER) /
                            VisionPipeline.VisionConstants.JunctionDetection.OnlyYForward.FORWARD_RANGE,
                            -0.3,
                            0
                        ),
                        0
