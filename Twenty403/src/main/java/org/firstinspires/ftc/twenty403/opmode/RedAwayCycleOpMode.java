...
import org.firstinspires.ftc.twenty403.command.autonomous.red_away.AutoRedAwayParkingSelectionCycleCommand;
...
@Autonomous(name = "RedAwayCycle")
public class RedAwayCycleOpMode extends CommandOpMode {
    public Robot robot;
        ...
        CommandScheduler.getInstance()
                .scheduleForState(
                        new SequentialCommandGroup(
                                new AutoRedAwayParkingSelectionCycleCommand(
                                        robot.visionSystem,
