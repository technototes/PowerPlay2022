...
@Autonomous(name = "Blue Away PreLoad")
public class BlueAwayPreLoad extends CommandOpMode {
    public Robot robot;
    ...
    public void uponInit() {
        ...
        CommandScheduler.getInstance()
                .scheduleForState(
                        new AutoBlueAwayParkingSelectionPreLoadCommand(robot.drivebaseSubsystem, robot.visionSystem, robot.liftSubsystem, robot.clawSubsystem),
