...
public class AutoLeftFullCycleRight extends SequentialCommandGroup {
    public AutoLeftFullCycleRight(Robot robot) {
        super(
                ...
                new TrajectorySequenceCommand(robot.drivebaseSubsystem, AutoConstants.Left.E_JUNCTION_TO_LEFT_PARK)
