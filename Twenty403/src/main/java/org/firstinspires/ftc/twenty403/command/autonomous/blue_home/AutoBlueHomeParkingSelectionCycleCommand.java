...
public class AutoBlueHomeParkingSelectionCycleCommand extends ChoiceCommand {
    public AutoBlueHomeParkingSelectionCycleCommand(
        ...
        super(
                new Pair<>(
                        ...
                        new AutoBlueHomeCycleLeft(drivebaseSubsystem, clawSubsystem, liftSubsystem)),
                new Pair<>(
                        visionSubsystem.visionPipeline::middle,
                        new AutoBlueHomeCycleMiddle(drivebaseSubsystem, clawSubsystem, liftSubsystem)),
                new Pair<>(
                        visionSubsystem.visionPipeline::right,
                        new AutoBlueHomeCycleRight(drivebaseSubsystem, clawSubsystem, liftSubsystem)));
    }
}
