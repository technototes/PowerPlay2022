...
public class AutoBlueHomePreLoadLeft extends SequentialCommandGroup {
    public AutoBlueHomePreLoadLeft(DrivebaseSubsystem drivebaseSubsystem, ClawSubsystem clawSubsystem, LiftSubsystem liftSubsystem) {
        super(
