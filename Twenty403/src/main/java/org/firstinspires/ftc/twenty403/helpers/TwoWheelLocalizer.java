...
public class TwoWheelLocalizer extends TwoTrackingWheelLocalizer{
    ...
    //public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
        ...
        public static double WHEEL_RADIUS = 1.37795276; // 35mm in inches
        ...
        public TwoWheelLocalizer(DcMotorEx parallel, DcMotorEx perpendicular, DrivebaseSubsystem drive) {
            super(Arrays.asList(
            ...
            perpendicularEncoder = perpendicular;
