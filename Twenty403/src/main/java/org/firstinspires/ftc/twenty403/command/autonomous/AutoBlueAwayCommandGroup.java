...
public class AutoBlueAwayCommandGroup extends SequentialCommandGroup {
    public AutoBlueAwayCommandGroup(
            MecanumDrivebaseSubsystem drive, ClawSubsystem claw, LiftSubsystem lift, ConeSubsystem cone) {
        super(
                new TrajectorySequenceCommand(drive, AutoConstantBlue.AWAY_JUNCTION)
