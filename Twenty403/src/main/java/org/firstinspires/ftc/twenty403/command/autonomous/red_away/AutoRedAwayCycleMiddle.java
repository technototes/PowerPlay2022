...
public class AutoRedAwayCycleMiddle extends SequentialCommandGroup {
    public AutoRedAwayCycleMiddle(
        ...
        super(new TrajectorySequenceCommand(drivebaseSubsystem, AutoConstantsRed.Away.START_TO_W_JUNCTION)
                .alongWith(
                        ...
                        new TrajectorySequenceCommand(
                                        drivebaseSubsystem, AutoConstantsRed.Away.W_JUNCTION_TO_MIDDLE_PARK)
                                .alongWith(new LiftCollectCommand(liftSubsystem))));
    }
}
