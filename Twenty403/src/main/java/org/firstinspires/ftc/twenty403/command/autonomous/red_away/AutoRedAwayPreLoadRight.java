...
public class AutoRedAwayPreLoadRight extends SequentialCommandGroup {
    public AutoRedAwayPreLoadRight(
        ...
        super(
                ...
                new TrajectorySequenceCommand(drivebaseSubsystem, AutoConstantsRed.Away.W_JUNCTION_TO_RIGHT_PARK));
    }
}
