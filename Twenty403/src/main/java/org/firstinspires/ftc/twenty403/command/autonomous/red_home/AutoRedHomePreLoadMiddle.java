...
public class AutoRedHomePreLoadMiddle extends SequentialCommandGroup {
    public AutoRedHomePreLoadMiddle(
        ...
        super(
                ...
                new TrajectorySequenceCommand(drivebaseSubsystem, AutoConstantsRed.Home.E_JUNCTION_TO_MIDDLE_PARK));
    }
}
