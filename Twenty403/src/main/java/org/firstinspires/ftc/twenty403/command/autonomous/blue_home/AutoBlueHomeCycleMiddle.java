...
public class AutoBlueHomeCycleMiddle extends SequentialCommandGroup {
    public AutoBlueHomeCycleMiddle(
            DrivebaseSubsystem drivebaseSubsystem, ClawSubsystem clawSubsystem, LiftSubsystem liftSubsystem) {
        super(new TrajectorySequenceCommand(drivebaseSubsystem, AutoConstantsBlue.Home.START_TO_W_JUNCTION)
                .alongWith(
                        ...
                        new TrajectorySequenceCommand(
                                        drivebaseSubsystem, AutoConstantsBlue.Home.W_JUNCTION_TO_MIDDLE_PARK)
                                .alongWith(new LiftCollectCommand(liftSubsystem))));
    }
}
