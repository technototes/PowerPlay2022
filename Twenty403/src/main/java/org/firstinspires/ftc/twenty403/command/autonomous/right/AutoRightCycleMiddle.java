...
public class AutoRightCycleMiddle extends SequentialCommandGroup {
    public AutoRightCycleMiddle(Robot r) {
        super(new TrajectorySequenceCommand(r.drivebaseSubsystem, AutoConstants.Right.START_TO_W_JUNCTION)
                .alongWith(
                        ...
                        new TrajectorySequenceCommand(
                                        r.drivebaseSubsystem, AutoConstants.Right.W_JUNCTION_TO_MIDDLE_PARK)
                                .alongWith(new LiftCollectCommand(r.liftSubsystem))));
    }
}
