...
public class AutoRightPreLoadRight extends SequentialCommandGroup {
    public AutoRightPreLoadRight(Robot r) {
        super(
                ...
                new TrajectorySequenceCommand(r.drivebaseSubsystem, AutoConstants.Right.W_JUNCTION_TO_RIGHT_PARK)
