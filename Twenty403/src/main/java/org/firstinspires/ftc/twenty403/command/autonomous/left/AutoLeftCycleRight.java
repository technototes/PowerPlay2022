...
public class AutoLeftCycleRight extends SequentialCommandGroup {
    public AutoLeftCycleRight(Robot r) {
        super(new TrajectorySequenceCommand(r.drivebaseSubsystem, AutoConstants.Left.START_TO_E_JUNCTION)
                .alongWith(
                        ...
                        new ClawOpenCommand(r.clawSubsystem),
                        new TrajectorySequenceCommand(r.drivebaseSubsystem, AutoConstants.Left.E_JUNCTION_TO_RIGHT_PARK)
                                .alongWith(new LiftCollectCommand(r.liftSubsystem))));
    }
}
