...
public class AutoRedHomeCycleRight extends SequentialCommandGroup {
    public AutoRedHomeCycleRight(
        ...
        super(new TrajectorySequenceCommand(drivebaseSubsystem, AutoConstantsRed.Home.START_TO_E_JUNCTION)
                .alongWith(
                        ...
                        new TrajectorySequenceCommand(
                                        drivebaseSubsystem, AutoConstantsRed.Home.E_JUNCTION_TO_RIGHT_PARK)
                                .alongWith(new LiftCollectCommand(liftSubsystem))));
    }
}
