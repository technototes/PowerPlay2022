...
AutoConstantsRed {
    ...
    public static class Away {
        ...
        public static ConfigurablePose BETWEEN_START_LEFT = new ConfigurablePose(-15, 60, toRadians(180));
        public static ConfigurablePose BETWEEN_START_RIGHT = new ConfigurablePose(-60, 60, toRadians(180));
