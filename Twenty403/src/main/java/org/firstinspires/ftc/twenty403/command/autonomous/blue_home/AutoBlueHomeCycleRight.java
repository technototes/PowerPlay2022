...
public class AutoBlueHomeCycleRight extends SequentialCommandGroup {
    public AutoBlueHomeCycleRight(DrivebaseSubsystem drivebaseSubsystem, ClawSubsystem clawSubsystem, LiftSubsystem liftSubsystem) {
        super(
                new TrajectorySequenceCommand(drivebaseSubsystem, AutoConstantsBlue.Home.START_TO_W_JUNCTION).alongWith((new LiftHighJunctionCommand(liftSubsystem)),
                        ...
                        new ClawOpenCommand(clawSubsystem),
                        new TrajectorySequenceCommand(drivebaseSubsystem, AutoConstantsBlue.Home.W_JUNCTION_TO_RIGHT_PARK).alongWith(new LiftCollectCommand(liftSubsystem))
                ));
    }
}
